...
internal object Dependencies {
    ...
    const val roundImageView = "com.github.mmmelik:RoundedImageView:${Versions.roundImageViewVersion}"
    ...
    const val infiniteCircleViewPager = "com.github.devlight:infinitecycleviewpager:${Versions.infinite_circle_view_pager_version}"
    const val glide = "com.github.bumptech.glide:glide:${Versions.glide}"
    const val glideAnnotation = "com.github.bumptech.glide:compiler:${Versions.glide}"
    const val lottieFiles = "com.airbnb.android:lottie:${Versions.lottieVersion}"
