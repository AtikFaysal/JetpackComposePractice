...
fun DependencyHandler.addGlideImageLoaderDependencies(){
    androidResponsiveSizeDependencies.forEachIndexed { index, dep ->
        if(index == 0)
            add("implementation",dep)
        else add("annotationProcessor",dep)
    }
}
...
fun DependencyHandler.addInfiniteCircleViewPager(){
    add("implementation",Dependencies.infiniteCircleViewPager)
}

fun DependencyHandler.addDotIndicator(){
    add("implementation",Dependencies.dotIndicator)
}

fun DependencyHandler.addLottieFiles(){
    add("implementation",Dependencies.lottieFiles)
}

fun DependencyHandler.addSpinKit(){
    add("implementation",Dependencies.spinKit)
}
...
fun DependencyHandler.addRoundImageviewDependencies(){
    add("implementation",Dependencies.roundImageView)
}
