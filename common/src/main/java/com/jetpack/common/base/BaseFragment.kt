package com.jetpack.common.base
...
abstract class BaseFragment<V : ViewBinding> : Fragment(){
    ...
    protected fun showAutoHideError(message: CharSequence?){
        if (!Alerter.isShowing) Alerter.create(requireActivity())
    ...
    protected fun showAutoHideSuccess(message: CharSequence?){
        if (!Alerter.isShowing) Alerter.create(requireActivity())
            .setText(message?:"Unknown Error")
            .hideIcon()
            .setBackgroundColorInt(Color.RED)
